...
public class IndexNestedScrollView extends NestedScrollView implements NestedScrollingParent2 {

	private static final String TAG = "IndexNestedScrollView";

	public IndexNestedScrollView(@NonNull Context context) {
		this(context, null);
	}

	public IndexNestedScrollView(@NonNull Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
	}
	...
	public boolean onStartNestedScroll(@NonNull View child, @NonNull View target, int axes, int type) {
		boolean b = target instanceof RecyclerView;
		Log.e(TAG, "onStartNestedScroll tagetView instanceof RecyclerView" + b +type +"");
		return true;
	}
	/**
	...
	public void onNestedScrollAccepted(@NonNull View child, @NonNull View target, int axes, int type) {
		Log.e(TAG, "onNestedScrollAccepted"+type +"");
	...
	public void onNestedPreScroll(@NonNull View target, int dx, int dy, @NonNull int[] consumed, int type) {
		Log.e(TAG, "onNestedPreScroll" + +dx +"消耗的距离" + +consumed[1]);
	...
	public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
		Log.e(TAG, "onNestedScroll" + target.getId()+"消耗的距离" + dyConsumed + "未消耗的距离" + dyUnconsumed);
